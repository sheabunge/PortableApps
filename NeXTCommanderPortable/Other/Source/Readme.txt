...
user in an INI file next to NeXTCommanderPortable.exe called NeXTCommanderPortable.ini.
...
copy AppNamePortable.ini from this directory to NeXTCommanderPortable.ini next to
NeXTCommanderPortable.exe. The options in the INI file are as follows:
