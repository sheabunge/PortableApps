...
user in an INI file next to QuickPHPPortable.exe called QuickPHPPortable.ini.
...
copy AppNamePortable.ini from this directory to QuickPHPPortable.ini next to
QuickPHPPortable.exe. The options in the INI file are as follows:
