...
user in an INI file next to BricxCCPortable.exe called BricxCCPortable.ini.
...
copy AppNamePortable.ini from this directory to BricxCCPortable.ini next to
BricxCCPortable.exe. The options in the INI file are as follows:
