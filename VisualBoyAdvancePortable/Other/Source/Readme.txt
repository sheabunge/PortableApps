...
user in an INI file next to VisualBoyAdvancePortable.exe called VisualBoyAdvancePortable.ini.
...
copy AppNamePortable.ini from this directory to VisualBoyAdvancePortable.ini next to
VisualBoyAdvancePortable.exe. The options in the INI file are as follows:
