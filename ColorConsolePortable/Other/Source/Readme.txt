...
user in an INI file next to ColorConsolePortable.exe called ColorConsolePortable.ini.
...
copy AppNamePortable.ini from this directory to ColorConsolePortable.ini next to
ColorConsolePortable.exe. The options in the INI file are as follows:
